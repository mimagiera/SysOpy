...
void(*createArrayOfPointers)(int);
void(*setCurrentPathAndFileName)(char*,char*,char*);
void(*findFileAndSaveToTmp)(void);
int(*saveTmpToBlock)(void);
void(*deleteBlockAtIndex)(int);
void(*allocateAtIndex)(int,char*);
...
void loadDynamicLibrary()
{
    ...
    createArrayOfPointers = (void (*) (int))dlsym(handle,"createArrayOfPointers");
    setCurrentPathAndFileName = (void(*)(char*,char*,char*))dlsym(handle,"setCurrentPathAndFileName");
    findFileAndSaveToTmp = (void(*)(void))dlsym(handle,"findFileAndSaveToTmp");
    saveTmpToBlock = (int(*)(void))dlsym(handle,"saveTmpToBlock");
    deleteBlockAtIndex = (void(*)(int))dlsym(handle,"deleteBlockAtIndex");
    allocateAtIndex = (void(*)(int,char*))dlsym(handle,"allocateAtIndex");
    deleteArray = (void(*)(void))dlsym(handle,"deleteArray");
